#### I HAVE MADE A CHANGE ON THE FIRST LINE OF THE FILE
...
resourcegroup_name = 'lrweek6'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'lrweek6'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
...
car.RowKey = '003'
car.make = 'Ferrari'
car.model = 'Testarrosa'	
car.year = 2010
car.color = 'Electric Yellow'	
car.price = 150000	
table_service.insert_entity('itemstable', car)
print('Created entry for Ferrari Testarrosa ...')
...
coffee = Entity()
coffee.PartitionKey = 'coffeeselection'
coffee.RowKey = '005'
...
print('Created entry for Pike Place Grande ...\n')
time.sleep(1)
...
coffee.price = .99
table_service.insert_entity('itemstable', coffee)
print('Created entry for Dunkin Donuts Medium ...\n')
time.sleep(1)
...
coffee.price = 1.2
table_service.insert_entity('itemstable', coffee)
print('Created entry for McDonalds Bold Large ...\n')
time.sleep(1)
